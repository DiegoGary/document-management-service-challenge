...
public class DefaultExceptionHandler extends ResponseEntityExceptionHandler {
  ...
  public ResponseEntity<ErrorResponse> badRequest(Exception exception) {
    ...
    return new ResponseEntity<>(
        createErrorResponse(exception, HttpStatus.BAD_REQUEST),
        new HttpHeaders(),
  ...
  public ResponseEntity<Object> unauthorized(Exception exception) {
    ...
    return new ResponseEntity<>(
        createErrorResponse(exception, HttpStatus.UNAUTHORIZED),
        new HttpHeaders(),
  ...
  public ResponseEntity<Object> forbidden(Exception exception) {
    ...
    return new ResponseEntity<>(
        createErrorResponse(exception, HttpStatus.FORBIDDEN),
        new HttpHeaders(),
  ...
  public ResponseEntity<Object> notFound(Exception exception) {
    ...
    return new ResponseEntity<>(
        createErrorResponse(exception, HttpStatus.NOT_FOUND),
        new HttpHeaders(),
  ...
  public ResponseEntity<Object> conflict(Exception exception) {
    ...
    return new ResponseEntity<>(
        createErrorResponse(exception, HttpStatus.CONFLICT),
        new HttpHeaders(),
        HttpStatus.CONFLICT);
  }
  ...
  public ResponseEntity<Object> payloadTooLarge(Exception exception) {
    ...
    return new ResponseEntity<>(
        createErrorResponse(exception, HttpStatus.PAYLOAD_TOO_LARGE),
        new HttpHeaders(),
  ...
  public ResponseEntity<Object> internalServerError(Exception exception) {
    ...
    return new ResponseEntity<>(
        createErrorResponse(exception, HttpStatus.INTERNAL_SERVER_ERROR),
        new HttpHeaders(),
