...
public interface DocumentController {
  ...
  ResponseEntity<DocumentDTO> uploadDocument(
      @Parameter(
              ...
              description = "The document upload user name",
              required = true,
              schema = @Schema())
      ...
      @Parameter(
              in = ParameterIn.DEFAULT,
              description = "The file as a multipart binary data",
              required = true,
              schema = @Schema())
  ...
  @Operation(
      ...
      description =
          "This endpoint allows to perform a paginated search of documents"
              + " by username, document name, and tags")
  @ApiResponse(
      responseCode = "200",
      description = "Document(s) were successfully found",
      content =
          @Content(
              mediaType = MediaType.APPLICATION_JSON_VALUE,
  ...
  ResponseEntity<PaginatedDocumentSearchResponse> searchDocuments(
      @Parameter(
              in = ParameterIn.DEFAULT,
              description = "The document search request object",
              required = true,
      ...
      @Parameter(
              in = ParameterIn.QUERY,
              description = "The page size (0-N)",
              required = false,
              schema = @Schema(minimum = "0", defaultValue = "20"))
  ...
  @Operation(
      ...
      description =
          "This endpoint allows to download a document by it's ID,"
