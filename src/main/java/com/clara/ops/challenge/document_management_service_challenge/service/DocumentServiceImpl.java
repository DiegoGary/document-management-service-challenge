...
public class DocumentServiceImpl implements DocumentService {
  ...
  public Document uploadDocument(
      String username, String name, List<String> tags, MultipartFile file) {
  ...
  public Page<Document> searchDocuments(
    ...
    if (username != null && filename != null && !tags.isEmpty()) {
      return documentRepository.findAllByUsernameAndNameAndTagName(
          username, filename, tags, pageable);
